...
class RemoteControlReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        val debugIntent = Intent("com.adamate.aaforaaos.DEBUG_KEY").apply {
        ...
        if (Intent.ACTION_MEDIA_BUTTON == action) {
            ...
            event?.let {
                ...
                val keyIntent = Intent(com.adamate.aaforaaos.contract.KeyIntent.action).apply {
                    putExtra(com.adamate.aaforaaos.contract.KeyIntent.extraEvent, it)
                    setPackage(context.packageName)
                }
