...
class Settings(context: Context) {
    ...
    /** When true, overlay shows FPS + frame gap (ms since last frame) for latency diagnostics. */
    var showLatencyDiagnostics: Boolean
        get() = prefs.getBoolean("show-latency-diagnostics", false)
        set(value) {
