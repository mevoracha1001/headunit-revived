...
import com.adamate.aaforaaos.aap.AapProjectionActivity
import com.adamate.aaforaaos.aap.AapService
import com.adamate.aaforaaos.app.BaseActivity
import androidx.lifecycle.lifecycleScope
import com.adamate.aaforaaos.utils.AppLog
import android.content.res.Configuration
import com.adamate.aaforaaos.utils.Settings
import com.adamate.aaforaaos.utils.SetupWizard
...
class MainActivity : BaseActivity() {
    ...
    private val finishReceiver = object : android.content.BroadcastReceiver() {
        override fun onReceive(context: android.content.Context, intent: Intent) {
            if (intent.action == "com.adamate.aaforaaos.ACTION_FINISH_ACTIVITIES") {
    ...
    override fun onStart() {
        ...
        ContextCompat.registerReceiver(
            this, finishReceiver,
            android.content.IntentFilter("com.adamate.aaforaaos.ACTION_FINISH_ACTIVITIES"),
